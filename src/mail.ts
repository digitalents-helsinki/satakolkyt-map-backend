  ...
  if (options.attachments) {
    Object.assign(opts, {
      attachments: [
        {
          filename: 'fbook.png',
          path: join(process.cwd(), '/assets/fbook.png'),
          cid: 'd0557c41-f196-41fd-abbf-cfe3dd5356dd'
        },
        {
          filename: 'inst.png',
          path: join(process.cwd(), '/assets/inst.png'),
          cid: '350673a5-5d18-4966-a9cb-fde89287b726'
        },
        {
          filename: 'twit.png',
          path: join(process.cwd(), '/assets/twit.png'),
          cid: 'abb0ad98-b191-4afb-8266-4b97c05938ea'
        },
        {
          filename: 'satakolkyt.jpeg',
          path: join(process.cwd(), '/assets/satakolkyt.jpeg'),
